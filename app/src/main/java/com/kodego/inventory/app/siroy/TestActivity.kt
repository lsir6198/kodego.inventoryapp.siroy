...
//            Toast.makeText(applicationContext, "Hello from Toast", Toast.LENGTH_LONG).show()
        ...
        binding.rgRadioGroup.setOnCheckedChangeListener{rgRadioGroup, checkOption ->
            when(checkOption){
                R.id.rgButton1 -> Toast.makeText(applicationContext, "Option 1 Selected", Toast.LENGTH_LONG).show()
                R.id.rgButton2 -> Toast.makeText(applicationContext, "Option 1 Selected", Toast.LENGTH_LONG).show()
                R.id.rgButton3 -> Toast.makeText(applicationContext, "Option 1 Selected", Toast.LENGTH_LONG).show()
            }
